document.addEventListener("DOMContentLoaded", function () {
  ...
  var frames = [
    ...
    ['<h1 class="title is-1"></h1>', 300],
    ['<h1 class="title is-1"><span class="cursor"></span></h1>', 300],
    ['<h1 class="title is-1">C<span class="cursor"></span></h1>', 200],
    ['<h1 class="title is-1">Cò<span class="cursor"></span></h1>', 120],
    ['<h1 class="title is-1">Còd<span class="cursor"></span></h1>', 120],
    ['<h1 class="title is-1">Còde<span class="cursor"></span></h1>', 120],
    ['<h1 class="title is-1">Còdec<span class="cursor"></span></h1>', 120],
    ['<h1 class="title is-1">Còdec</h1>', 200],
    ['<h1 class="title is-1">Còdec<span class="cursor highlight"></span></h1>', 300],
    [
    ...
    ['<h1 class="title is-1"><span class="bytes">1100100111</span></h1>', 200],
    [
    ...
    ['<h1 class="title is-1">Còdec<span class="cursor"></span></h1>', 120],
    ['<h1 class="title is-1">Còdec</h1>', 120],
    ['<h1 class="title is-1">Còdec<span class="cursor"></span></h1>', 300],
    ['<h1 class="title is-1">Còde<span class="cursor"></span>c</h1>', 200],
    ['<h1 class="title is-1">Còd<span class="cursor"></span>ec</h1>', 120],
    ['<h1 class="title is-1">Cò<span class="cursor"></span>dec</h1>', 120],
    ['<h1 class="title is-1">Còdec</h1>', 120],
    [
